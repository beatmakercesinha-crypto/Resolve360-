...
export const Header: React.FC<HeaderProps> = ({
  ...
  const navLinks = [
    ...
    { label: 'Diagnóstico IA', href: '#diagnostico-ia' },
    { label: 'Simulador 360°', href: '#simulador-cobertura' },
    { label: 'Clube Pelotas', href: '#clube-manutencao' },
          ...
          <div className="flex items-center gap-4 text-slate-400">
            {onOpenPassport && (
              <button
                ...
                className="text-xs text-slate-300 hover:text-blue-400 flex items-center gap-1 transition-colors"
              >
                <QrCode className="w-3.5 h-3.5 text-blue-400" />
                <span>Passaporte da Casa</span>
              </button>
            )}
            ...
            {onOpenTracking && (
              ...
              >
                ...
                <span>Rastrear Técnico</span>
              </button>
            )}

            {isAuthenticated && (
              <span className="text-xs text-blue-400 font-semibold border-l border-slate-700 pl-3">
                👤 {currentUser?.name.split(' ')[0]} ({currentUser?.neighborhood})
              </span>
            )}
          </div>
        </div>
          ...
          <div className="hidden sm:flex items-center gap-3">
            ...
            {isAuthenticated ? (
              <div className="relative">
                ...
                {userDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-slate-200 py-2 z-50 text-xs text-slate-700 animate-in fade-in slide-in-from-top-2">
                    ...
                    >
                      ...
                      <span>Meu Painel & Histórico</span>
                    </a>
                    ...
                    {onOpenPassport && (
                      ...
                      >
                        ...
                        <span>Passaporte Digital do Imóvel</span>
                      </button>
                    )}
                    ...
                    {onOpenTracking && (
                      ...
                      >
                        ...
                        <span>Rastrear Técnico a Caminho</span>
                      </button>
                    )}
